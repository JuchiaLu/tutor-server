package com.juchia.tutor.business.common.generator;
...
//    private AbstractTemplateEngine templateEngine; 模版引擎配置 ,默认即可
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/tutor_business?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.juchia.tutor.business2");
