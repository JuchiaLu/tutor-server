package com.juchia.tutor.pay.common.generator;
...
//    private AbstractTemplateEngine templateEngine; 模版引擎配置 ,默认即可
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/tutor_pay?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.juchia.tutor.pay");
